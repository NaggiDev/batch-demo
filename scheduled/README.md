...
# Info archetype
 ...
 ArtifactId | arch-client-archetype
 Version | 	1.0.1
...
- Port GRPC mặc đình là 8081 (không thay đổi)
...
@SpringBootApplication(
        ...
        , scanBasePackages = {"vn.com.viettel.vds.archclient"}// Thư mục packet dự án của bạn
)
...
@SpringBootApplication(
        exclude = KafkaAutoConfiguration.class
        , scanBasePackages = {"vn.com.viettel.vds.archclient"}
)
...
### Hot Reload config
- Hệ thống VDS đang có tính năng hot reload 1 số config tại thời điểm runtime
...
```
#### `Lưu ý`
- Hệ thống của bên VDS đang sử dụng hot reaload config, bản chất spring làm điều này thông qua proxy pattern.
...
- Lib có tạo sẵn 1 số constant Header VDS hay sử dụng. Có thể xem tại `vn.com.viettel.vds.arch.constant.HeaderConstant`
```java
...
springdoc.api-docs.title=Viettel Digital Service
springdoc.api-docs.description=Chuyển dịch công nghệ
springdoc.api-docs.contactName=CDCN
springdoc.api-docs.contactUrl=https://transformation.digital.vn/
...
- Mọi người có thể vào `vn.com.viettel.vds.arch.validator.annotation` để tham khảo danh sách
