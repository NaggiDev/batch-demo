...
import vn.com.viettel.vds.arch.config.OpenApiConfig;
...
@SpringBootTest(classes = {Main.class, OpenApiConfig.class}, properties = {
        "io.springfox.staticdocs.outputDir=docs"})
...
public class GenerateSwaggerTest {
    ...
    public void createSpringfoxSwaggerJson() throws Exception {
        ...
        MvcResult mvcResult = this.mockMvc
                .perform(get(env.getProperty("springdoc.api-docs.path", "/v3/api-docs"))
        ...
        try (BufferedWriter writer = Files
                .newBufferedWriter(Paths.get(outputDir, "swagger.yaml"), StandardCharsets.UTF_8)) {
